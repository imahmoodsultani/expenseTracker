...
CREATE TABLE `Expense` (
    ...
    `recurrenceFrequency` ENUM('WEEKLY', 'MONTHLY', 'YEARLY') NULL,
    `nextDueDate` DATETIME(3) NULL,
    `recurrenceLastGeneratedDate` DATETIME(3) NULL,
...
-- AddForeignKey
ALTER TABLE `Expense` ADD CONSTRAINT `Expense_recurrenceParentId_fkey` FOREIGN KEY (`recurrenceParentId`) REFERENCES `Expense`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
